...
import { ACCESS_CONFIG, AccessConfig } from '../config';
...
export class AccessGuard implements CanActivate {
  ...
  constructor(private router: Router, private accessService: AccessService, @Inject(ACCESS_CONFIG) private config: AccessConfig) {
  }
